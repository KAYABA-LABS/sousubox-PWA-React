  ...
  return (
    <div className="min-h-screen bg-[#FBF6EF] dark:bg-[#0C0F14] p-6 pb-32">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-[#0C0F14] dark:text-white mb-6">Freeze Card</h1>

        <div
          className={`rounded-2xl p-6 mb-6 ${
            isFrozen
              ? "bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20"
              : "bg-white dark:bg-[#151A1F]"
          }`}
        >
          <div className="flex items-center gap-4 mb-4">
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center ${
                isFrozen ? "bg-blue-100 dark:bg-blue-500/20" : "bg-black/5 dark:bg-white/5"
              }`}
            >
              <Snowflake
                className={`w-6 h-6 ${
                  isFrozen ? "text-blue-600 dark:text-blue-400" : "text-gray-500 dark:text-gray-400"
                }`}
              />
            </div>
            <div>
              <h2 className="text-[#0C0F14] dark:text-white font-semibold">
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl font-medium transition-colors ${
              isFrozen
                ? "bg-[#0D4F3C] text-white hover:bg-[#156B53]"
        ...
        <div className="bg-white dark:bg-[#151A1F] rounded-2xl p-5 space-y-4">
        ...
        <div className="bg-white dark:bg-[#151A1F] rounded-2xl p-5 mt-3">
          <div className="flex gap-3">
