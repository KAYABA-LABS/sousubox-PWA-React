    ...
    <div className="min-h-screen bg-[#FBF6EF] dark:bg-[#0C0F14] p-6 pb-32">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-[#151A1F] rounded-2xl p-6 text-center">
          ...
          <h1 className="text-xl font-bold text-[#0C0F14] dark:text-white mb-2">Virtual Cards</h1>
          <p className="text-gray-500 dark:text-gray-400">Card data will appear when the backend provides it.</p>
        </div>
      </div>
    </div>
  );
