      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-3">
          {docs.map((doc, i) => (
            <button
              key={i}
              className="w-full bg-[#151A1F] rounded-2xl p-4 flex justify-between items-center hover:bg-[#1A1F25] transition-colors"
            >
              ...
              <span className="text-[#00E660] text-sm">View</span>
            </button>
          ))}
        </div>
      </div>
