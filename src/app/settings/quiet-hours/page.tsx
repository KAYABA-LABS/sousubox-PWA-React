  ...
  return (
    <div className="min-h-screen bg-[#0C0F14] p-6 pb-32">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-white mb-6">Quiet Hours</h1>
        <div className="bg-[#151A1F] rounded-2xl p-4 mb-4 flex justify-between items-center">
