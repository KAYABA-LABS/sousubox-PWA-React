  ...
  return (
    <div className="min-h-screen bg-[#0C0F14] p-6 pb-32">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-2xl font-bold text-white mb-6">Statements</h1>
          ...
          {statements.map((stmt, i) => (
            ...
            >
              <div className="flex gap-3 items-center">
                ...
                <div>
                  <h3 className="text-white font-medium">{stmt.month}</h3>
                  <p className="text-xs text-gray-400">{stmt.size}</p>
                </div>
              </div>
