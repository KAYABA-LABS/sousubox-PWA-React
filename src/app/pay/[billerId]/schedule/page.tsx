  ...
  return (
    <div className="min-h-screen bg-[#0C0F14] flex flex-col">
      ...
      <header className="bg-[#0C0F14] px-5 pt-6 pb-4 border-b border-white/5">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Choose payment timing</p>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 px-5 py-6">
        ...
        >
          {/* Payment Summary */}
          <div className="bg-[#151A1F] rounded-xl p-4 text-center">
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-medium text-gray-400">When to pay</h2>
            ...
            <button
              ...
              className={`w-full rounded-xl p-4 border-2 transition-all ${
                timing === "now"
                  ? "bg-[#00E660]/10 border-[#00E660]"
                  : "bg-[#151A1F] border-white/10 hover:bg-[#1A1F25]"
              }`}
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mt-0.5 ${
                    timing === "now" ? "border-[#00E660]" : "border-gray-500"
                  }`}
                >
                  {timing === "now" && (
                    <div className="w-2.5 h-2.5 rounded-full bg-[#00E660]" />
                  )}
                </div>
                <div className="flex-1 text-left">
                  <p className="text-white font-medium mb-1">Pay now</p>
                  <p className="text-sm text-gray-400">
            ...
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mt-0.5 ${
                    timing === "later" ? "border-[#00E660]" : "border-gray-500"
                  }`}
                >
                  {timing === "later" && (
                    <div className="w-2.5 h-2.5 rounded-full bg-[#00E660]" />
              ...
              <div className="bg-[#151A1F] rounded-xl p-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0C0F14] border border-white/10 rounded-xl pl-12 pr-4 py-3 text-white focus:outline-none focus:border-[#00E660] transition-colors"
                  />
                </div>
              </div>
            </motion.div>
