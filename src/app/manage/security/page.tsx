    ...
    <main id="main-content" role="main" className="min-h-screen bg-[#0C0F14] flex flex-col">
      ...
      <main className="flex-1 px-5 py-6 overflow-y-auto">
        ...
        >
          ...
          <div>
            ...
            <div className="bg-[#151A1F] rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-[#00E660]/10 flex items-center justify-center">
                  <Mail className="w-5 h-5 text-[#00E660]" />
                </div>
              ...
              <Button className="w-full bg-[#0C0F14] hover:bg-[#151A1F] border border-white/10 text-white py-2.5 rounded-lg transition-colors text-sm font-medium">
                Change email
              </Button>
            </div>
          </div>
          ...
          {/* Password */}
          <div>
            <h2 className="text-sm font-medium text-gray-400 mb-3">Password</h2>
            <div className="bg-[#151A1F] rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-[#00E660]/10 flex items-center justify-center">
                  <Lock className="w-5 h-5 text-[#00E660]" />
                </div>
                <div className="flex-1">
          ...
          <div>
            ...
            <div className="bg-[#151A1F] rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-[#00E660]/10 flex items-center justify-center">
                  <Shield className="w-5 h-5 text-[#00E660]" />
                </div>
                <div className="flex-1">
                ...
                <Button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${
                    otpEnabled ? "bg-[#00E660]" : "bg-gray-600"
                  }`}
