    ...
    <main id="main-content" role="main" className="min-h-screen bg-[#0C0F14] flex flex-col">
      ...
      <header role="banner" className="bg-[#0C0F14] px-5 pt-6 pb-4 border-b border-white/5">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">View your information</p>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 px-5 py-6 overflow-y-auto">
        ...
        >
          {/* Profile Section */}
          <div>
            <h2 className="text-sm font-medium text-gray-400 mb-3">Profile</h2>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                className="w-full bg-[#151A1F] border border-white/10 rounded-xl p-4 flex items-center justify-between group hover:bg-[#1A1F25] transition-colors"
              ...
              >
                ...
                {copiedField === "accountNumber" ? (
                  <CheckCircle2 className="w-5 h-5 text-[#00E660]" />
                ) : (
                  <Copy className="w-5 h-5 text-gray-500 group-hover:text-gray-400" />
                )}
              </Button>
              ...
              {/* Account Status */}
              <div className="w-full bg-[#151A1F] border border-white/10 rounded-xl p-4">
                <p className="text-xs text-gray-500 mb-1">Account status</p>
                <div className="flex items-center gap-2">
                  <Badge className="px-2.5 py-0.5 bg-[#00E660]/20 text-[#00E660] rounded-full text-xs font-medium">
                    {userData.status}
                  </Badge>
                </div>
              </div>
