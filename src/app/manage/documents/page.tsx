      ...
      <header className="bg-[#0C0F14] px-5 pt-6 pb-4 border-b border-white/5">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Statements & confirmations</p>
          </div>
        </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              filter === "all"
                ...
                : "bg-[#151A1F] text-gray-400 hover:bg-[#1A1F25]"
            }`}
          >
            All
          </button>
        ...
        >
          {filteredDocuments.map((doc, index) => (
            <motion.div
              ...
              className="bg-[#151A1F] hover:bg-[#1A1F25] rounded-xl p-4 flex items-center gap-4 transition-colors"
            >
              ...
              <button
                onClick={() => {}}
                className="w-10 h-10 rounded-full bg-[#00E660]/10 hover:bg-[#00E660]/20 flex items-center justify-center transition-colors"
              >
                <Download className="w-5 h-5 text-[#00E660]" strokeWidth={2} />
              </button>
            </motion.div>
          ))}
